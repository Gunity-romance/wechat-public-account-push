export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb809a63caaa27287",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "793c589dc9052e299320551297b7598c",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "mom", "year": "1979", "date": "09-25"},
      ],
    ...
    },
    {
      ...
      horoscopeDateType: '今日',
      openUrl: "https://s.weibo.com/top/summary?cate=realtimehot",
      festivals: [{"type": "*生日", "name": "G", "year": "2000", "date": "08-08"},],
      customizedDateList: [{"keyword": "love_day", date: "2020-11-18"},]
    },
    {
      name: "老婆3",
      id: "",
  ...
  CALLBACK_TEMPLATE_ID: "5jYywHXlIAt_5IjqwzjUhutzXRGql9LdNZSg2Az0AhM",
